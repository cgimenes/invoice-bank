...
RSpec.describe "/transfers", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get transfers_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Transfer" do
        expect {
          post transfers_url,
               params: { transfer: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Transfer" do
        expect {
          post transfers_url,
               params: { transfer: invalid_attributes }, as: :json
        }.to change(Transfer, :count).by(0)
      end

      it "renders a JSON response with errors for the new transfer" do
        post transfers_url,
             params: { transfer: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested transfer" do
        ...
        patch transfer_url(transfer),
              params: { transfer: new_attributes }, headers: valid_headers, as: :json
        transfer.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested transfer" do
      transfer = Transfer.create! valid_attributes
      expect {
        delete transfer_url(transfer), headers: valid_headers, as: :json
      }.to change(Transfer, :count).by(-1)
    end
  end
end
